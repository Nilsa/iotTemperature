...
awshost = "a2v66kidrncsm5-ats.iot.us-east-1.amazonaws.com"      # Endpoint
awsport = 8883                                              # Port no.   
clientId = "piTemperature"                                     # Thing_Name
thingName = "piTemperature"                                    # Thing_Name
caPath = "root-CA.crt"                                      # Root_CA_Certificate_Name
certPath = "piTemperature.cert.pem"                            # <Thing_Name>.cert.pem
keyPath = "piTemperature.private.key"                          # <Thing_Name>.private.key
